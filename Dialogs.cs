    ...
    public partial class Dialogs : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        private void Dialogs_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                BugReporter reporter = new BugReporter("Dialog_Load", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void richTextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_rTextBox1_TextChanged", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void richTextBox1_VScroll(object sender, EventArgs e)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_rTextBox1_VScroll", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void RichHighlight(int start)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_RichHighlight", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void ShowTranslate()
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_ShowTranslate", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void CodeCompletion(object sender, KeyEventArgs e)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_CodeCompletion", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void richTextBox1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_rTextBox1_KeyDown", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void richTextBox1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_rTextBox1_MouseClick", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void ccListBox_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_ccListBox_KeyDown", exStr);
                reporter.ShowDialog();
            }
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                string exStr = ex.ToString().Replace("\n", "{LF}").Replace("\r", "{CR}").Replace("/", "{Slash}").Replace("\\", "{Backslash}").Replace("%", "{Percent}").Replace("?", "{Question}").Replace("&", "{And}").Replace("$", "{Dollar}").Replace("@", "{At}").Replace("#", "{Hash}");
                BugReporter reporter = new BugReporter("Dialog_Timer1", exStr);
                reporter.ShowDialog();
            }
        }
